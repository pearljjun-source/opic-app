...
export const ERROR_CODES = {
  ...
  VAL_INVITE_OWN_CODE: 'VAL_INVITE_OWN_CODE',
  ...
  BILLING_REFUND_NOT_ALLOWED: 'BILLING_REFUND_NOT_ALLOWED',
  BILLING_REFUND_PERIOD_EXPIRED: 'BILLING_REFUND_PERIOD_EXPIRED',
  BILLING_ALREADY_REFUNDED: 'BILLING_ALREADY_REFUNDED',
...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  VAL_INVITE_OWN_CODE: '본인이 생성한 초대 코드는 사용할 수 없습니다',
  ...
  BILLING_REFUND_NOT_ALLOWED: '환불이 불가능한 결제입니다',
  BILLING_REFUND_PERIOD_EXPIRED: '환불 가능 기간(14일)이 지났습니다',
  BILLING_ALREADY_REFUNDED: '이미 환불된 결제입니다',
  BILLING_REFUND_FAILED: '환불 처리에 실패했습니다',
...
const ERROR_CODE_CATEGORY: Record<ErrorCode, ErrorCategory> = {
  ...
  VAL_INVITE_OWN_CODE: 'validation',
  ...
  BILLING_REFUND_NOT_ALLOWED: 'permission',
  BILLING_REFUND_PERIOD_EXPIRED: 'permission',
  BILLING_ALREADY_REFUNDED: 'conflict',
  BILLING_REFUND_FAILED: 'server',
...
const RPC_ERROR_MAP: Record<string, ErrorCode> = {
  ...
  'FORBIDDEN': ERROR_CODES.PERM_ADMIN_ONLY,
  ...
  'CANNOT_USE_OWN_CODE': ERROR_CODES.VAL_INVITE_OWN_CODE,
  ...
  'ALREADY_USED_CODE': ERROR_CODES.CONFLICT_CODE_USED,
  'TEACHER_INVITE_NO_CLASS': ERROR_CODES.VAL_FAILED,
  'CLASS_NOT_FOUND': ERROR_CODES.NF_CLASS,
  'INVALID_MAX_USES': ERROR_CODES.VAL_FAILED,
