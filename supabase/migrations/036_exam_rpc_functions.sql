-- ============================================================================
-- 036_exam_rpc_functions.sql
-- OPIc 시험 RPC 함수: 문제 생성 + 사전 검증
-- ============================================================================

-- ============================================================================
-- 1. check_exam_availability — 시험 시작 전 사전 검증
-- ============================================================================
...
-- ============================================================================
-- 2. generate_mock_exam_questions — 모의고사 문제 생성
--
-- Q1: 자기소개 (채점 안 함)
-- Q2-Q4: 서베이 토픽 콤보1 (describe → routine → experience)
-- Q5-Q7: 서베이/돌발 콤보2 (describe → comparison → experience)
-- Q8-Q10: 돌발 토픽 콤보3 (describe → routine → experience)
-- Q11-Q13: 롤플레이 콤보 (ask → problem → experience)
-- Q14-Q15: 레벨5-6→어드밴스 / 레벨3-4→두번째 롤플레이
-- ============================================================================
